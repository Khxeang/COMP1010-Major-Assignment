public class AntiHeroes extends Character{ //Anti-Hero class is inheriting from the Character class.
    public AntiHeroes(String name, int health, int defense, int passiveMinDamage, int passiveMaxDamage, int itemDamage, int UltimateDamage, String ultimateAttackName ,Item Item){

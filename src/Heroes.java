public class Heroes extends Character { //Hero class is inheriting from the Character class.
    public Heroes(String name, int health, int defense, int passiveMinDamage, int passiveMaxDamage, int itemDamage, int UltimateDamage,String ultimateAttackName, Item Item){
